...
def new_cust():
    ...
    customer = Bank_accnt(name=name, mobile_No=mobile_No, initial_depo=initial_depo, pin=pin)
...
Press 4 for exit\n''')
    ...
    if user_input1 == '1':
        ...
        print('There currently', Bank_accnt.no_of_cust,'customers in Corporate bank.')
    elif user_input1 == '4':
        print('Exited')
        break
    else:
